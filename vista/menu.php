  ...
  <div class="navbar-fixed">
    <nav>
      ...
      <div class="nav-wrapper  ">
        <a href=<?php echo 'http://' . $_SERVER['SERVER_NAME'] . '/modulo/Vista/index.php'; ?> class="brand-logo"><i class="material-icons">business</i><?php echo $usuario; ?></a>

        <a href="#" data-activates="mobile-demo" class="button-collapse"><i class="material-icons">menu</i></a>
        <ul class="right hide-on-med-and-down">

          <li><a href=<?php echo 'http://' . $_SERVER['SERVER_NAME'] . '/modulo/controlador/cerrar.php'; ?>>CERRAR SESIÓN</a></li>
          <li><a href="./././formularios/frm_actualizarcontrasena.php">ACTUALIZAR CONTRASEÑA</a></li>

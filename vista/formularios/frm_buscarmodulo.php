...
require_once '../../Controlador/c_cargarmodulo.php';
...
<head>
  ...
  <meta charset="UTF-8">
  <title>Buscar/Actualizar Modulos</title>
...
<div class="container  teal lighten-5">
      ...
      <div class="container-fluid card-panel  teal lighten-2 center-align">
        <div class="row">
            <label style="color: #FFF;"><h5>BUSCAR MÓDULO</h5></label>
          </div>
      </div> <div class="container-fluid  center-align ">
        <a class="waves-effect waves-light btn-large" href="frm_crearmodulo.php" style="width: 40%">Agregar Módulo</a>

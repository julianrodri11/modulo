...
<head>
  ...
  <meta charset="UTF-8">
  <title>BUSCAR AUTENTICACIÓN </title>
...
<div class="container  teal lighten-5">
      ...
      <div class="container-fluid card-panel  teal lighten-2 center-align">
        <div class="row">
            <label style="color: #FFF;"><h5>BUSCAR AUTENTICACIÓN </h5></label>
          </div>
      </div>   
      <div class="container-fluid  center-align ">
        <a class="waves-effect waves-light btn-large" href="frm_crearlogin.php" style="width: 40%">Crear Autenicación</a>
        ...
        <div class="row">
          <div class="input-field col s12 m12 l12">
            ...
            <label for="input_text">BUSCAR AUTENTICACIÓN  POR ESTADO, CORREO O ESTADO
            </label>
          </div>
        </div>
